    ...
    return (
        <div className='container bg-secondary-dark rounded-[10px] md:p-10 p-5 my-[80px] md:flex items-center justify-between'>
            <div className='mb-10 md:mb-0'>
                ...
                <div onClick={() => navigate('/offer')} className='md:w-[207px] cursor-pointer bg-main-yellow py-4 rounded-[8px] flex items-center justify-center gap-2 text-[14px] text-main-dark font-semibold'>
