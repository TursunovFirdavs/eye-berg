      ...
      <div className="container">
        <div className='absolute top-10'>
            ...
            <div className='md:flex items-center gap-6'>
                ...
                <div onClick={() => navigation('/offer')} className='md:w-[207px] cursor-pointer w-full mt-3 md:mt-0 bg-main-yellow rounded-[8px] py-[18px] text-[14px] text-main-dark font-semibold flex items-center justify-center gap-2'>
