...
const Offer = () => {
  return (
    <div className='flex items-center justify-center md:h-[100vh]'>
      <div className='bg-secondary-dark md:w-[555px] w-[345px] md:px-[80px] px-4 my-[100px] md:my-0 rounded-[10px] py-10'>
        <p className='text-[30px] font-bold text-center'>Получить предложение</p>
        <p className='text-center mt-4 mb-10'>Пожалуйста, укажите свои данные. Наш менеджер свяжется с вами в течение 15 минут.</p>
